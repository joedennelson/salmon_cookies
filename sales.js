...
// constructer function is creating a function with empty properties that we can fill with multiple objects 

// - what makes it a constructor function?


// - what do you think the CookieStand.all.push(all) method is doing?
// taking all the properties inside of the function and pushing it to the object that we create 
...
// its calculating how many customers you get each hour
...
new CookieStand('Dubai', 18, 37, 4.2);

new CookieStand('Paris', 14, 34, 3.7);

new CookieStand('Lima', 19, 40, 4.5);
